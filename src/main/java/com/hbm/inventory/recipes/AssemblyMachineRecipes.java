...
public class AssemblyMachineRecipes extends GenericRecipes<GenericRecipe> {
	...
	public void registerDefaults() {
		...
		this.register(new GenericRecipe("ass.secureaccess").setup(400, 100).outputItems(new ItemStack(ModBlocks.secure_access_door, 1))
				.inputItems(new OreDictStack(STEEL.plateCast(), 12), new OreDictStack(ALLOY.plate(), 16), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModItems.motor, 4), new OreDictStack(DURA.bolt(), 32), new OreDictStack(KEY_BLUE, 8)));
		...
		this.register(new GenericRecipe("ass.slidinggate").setup(200, 100).outputItems(new ItemStack(ModBlocks.sliding_gate_door, 1))
				.inputItems(new OreDictStack(PB.plate(), 4), new OreDictStack(STEEL.plate(), 12), new OreDictStack(ALLOY.plate(), 4), new ComparableStack(ModItems.plate_polymer, 2), new OreDictStack(STEEL.block(), 1), new ComparableStack(ModItems.motor, 2), new OreDictStack(DURA.bolt(), 2), new OreDictStack(KEY_WHITE, 2)));
